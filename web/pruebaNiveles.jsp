...
<div class="container-lg my-2">
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div id="section1">
                <h3>Hola Mundo, comentarios en java</h3>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                    <form>
                        <label for="finalizado1" >Completado</label>
                        <input type="checkbox" id="finalizado1" <c:if test="${not empty tema1}">checked</c:if>/>
                        <a class="btn btn-primary" href="MarcarFinalizado.jsp?tema=7&nivel=1&Action=<c:if test="${not empty tema1}">Eliminar</c:if>">Marcar como Finalizado</a>
                    </form>
                </c:if>
                <%@include file="temas/Intermedio/try_catch.jsp"%>
            </div><hr>
            <div id="section2">
                <div><h3>Tipos de datos e inicialización de variables</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
            ...
            <div id="section3">
		<div><h3>Conversión de tipos de datos</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
            ...
            <div id="section4">
                 <div><h3>Tipos de operadores</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
            ...
            <div id="section5">
                <div><h3>Leer caracteres desde el teclado</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
            ...
            <div id="section6">
                <div><h3>Manejo de cadenas de caracteres (String)</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
            ...
            <div id="section7">
                <div><h3>Estructuras condicionales</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
            ...
            <div id="section8">
                <div><h3>Bucles(Ciclos iterativos)</h3></div>
                <c:if test="${(not empty sessionScope.user) && (result.rows[0].cant >0)}">
                <form>
                    <label for="finalizado1" >Completado</label>
